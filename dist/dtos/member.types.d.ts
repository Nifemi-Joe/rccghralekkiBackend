export interface Member {
    ...
    family_id?: string;
    family_role?: 'father' | 'mother' | 'son' | 'daughter' | 'grandfather' | 'grandmother' | 'grandson' | 'granddaughter' | 'uncle' | 'aunt' | 'nephew' | 'niece' | 'cousin' | 'brother' | 'sister' | 'brother_in_law' | 'sister_in_law' | 'father_in_law' | 'mother_in_law' | 'stepfather' | 'stepmother' | 'stepson' | 'stepdaughter' | 'guardian' | 'ward' | 'other';
...
export interface AuditLog {
    ...
    action_type: 'member' | 'event' | 'attendance' | 'user' | 'family';
