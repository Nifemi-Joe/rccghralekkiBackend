...
class ServiceReportRepository {
    async create(churchId, userId, data) {
      ...
      `;
            ...
            if (error instanceof AppError_1.AppError)
                throw error;
            logger_1.default.error('Error in ServiceReportRepository.create:', error);
            throw new AppError_1.AppError('Failed to create service report', 500);
        }
        finally {
            client.release();
        }
    }
    async findAll(churchId, filters = {}) {
        const client = await database_1.pool.connect();
        try {
            let query = `
        SELECT sr.*,
      ...
      `;
            ...
            logger_1.default.error('Error in ServiceReportRepository.findAll:', error);
    ...
    async findById(churchId, reportId) {
        const client = await database_1.pool.connect();
        try {
            const query = `
        SELECT sr.*,
      ...
      `;
            ...
            logger_1.default.error('Error in ServiceReportRepository.findById:', error);
    ...
    async update(churchId, reportId, data) {
        const client = await database_1.pool.connect();
        try {
            const updates = [];
            const values = [];
      ...
      `;
            ...
            logger_1.default.error('Error in ServiceReportRepository.update:', error);
            throw new AppError_1.AppError('Failed to update service report', 500);
        }
        finally {
            client.release();
        }
    }
    async delete(churchId, reportId) {
        const client = await database_1.pool.connect();
        try {
            ...
            logger_1.default.error('Error in ServiceReportRepository.delete:', error);
            throw new AppError_1.AppError('Failed to delete service report', 500);
        }
        finally {
            client.release();
        }
    }
    async getSummary(churchId, startDate, endDate) {
        const client = await database_1.pool.connect();
        try {
            let dateFilter = '';
            const values = [churchId];
      ...
      `;
            ...
            logger_1.default.error('Error in ServiceReportRepository.getSummary:', error);
            throw new AppError_1.AppError('Failed to fetch service report summary', 500);
        }
        finally {
            client.release();
        }
...
//# sourceMappingURL=ServiceReportRepository.js.map