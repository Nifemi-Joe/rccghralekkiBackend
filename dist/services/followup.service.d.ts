import { FollowUpDepartment, FollowUpMember, FollowUpAssignment, FollowUpActivity, MessageTemplate, FollowUpStatistics, CreateFollowUpMemberDTO, UpdateFollowUpMemberDTO, CreateAssignmentDTO, BulkCreateAssignmentsDTO, UpdateAssignmentDTO, ReassignMemberDTO, SendMessageDTO, RecordActivityDTO, CreateTemplateDTO, UpdateTemplateDTO, FollowUpFilters, ActivityFilters, UpdateDepartmentSettingsDTO, PaginatedAssignments, PaginatedActivities, BulkAssignmentResult } from '@/dtos/followup.types';
export declare class FollowUpService {
    ...
    reassignMember(churchId: string, assignmentId: string, data: ReassignMemberDTO): Promise<FollowUpAssignment>;
    getActivities(churchId: string, assignmentId: string, filters: ActivityFilters): Promise<PaginatedActivities>;
    sendMessage(churchId: string, userId: string, data: SendMessageDTO): Promise<FollowUpActivity>;
