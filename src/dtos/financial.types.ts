...
export interface TransactionFilters {
    ...
    expenseCategoryId?: string;
    approvalStatus?: ApprovalStatus; // Added for expense filtering
    search?: string;
    page?: number;
    limit?: number;
}
...
// Renamed from EventFinancials to match Repository import
