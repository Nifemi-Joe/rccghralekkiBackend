...
export class UserRepository {
    ...
    async create(data: CreateUserDTO): Promise<User> {
        ...
        try {
            ...
            logger.info(`User created: ${result.rows[0].id} (${data.email})`);
            ...
            if (error.code === '23503') {
                throw new AppError('Invalid church ID', 400);
            }
    ...
    async createMany(users: CreateUserDTO[]): Promise<User[]> {
        ...
        try {
            ...
            logger.info(`Bulk created ${createdUsers.length} users`);
            return createdUsers;
        } catch (error: any) {
            await client.query('ROLLBACK');
            logger.error('Error in UserRepository.createMany:', error);

            if (error.code === '23505') {
                throw new AppError('One or more emails already exist', 409);
            }

            throw new AppError('Failed to create users', 500);
        } finally {
            client.release();
        }
    }
    ...
    async findByIdSafe(id: string): Promise<UserWithoutPassword | null> {
        ...
        try {
            ...
            logger.error('Error in UserRepository.findByIdSafe:', error);
            throw new AppError('Failed to fetch user', 500);
        } finally {
            client.release();
        }
    ...
    async findByEmailSafe(email: string): Promise<UserWithoutPassword | null> {
        ...
        try {
            ...
            logger.error('Error in UserRepository.findByEmailSafe:', error);
            throw new AppError('Failed to fetch user', 500);
        } finally {
            client.release();
        }
     ...
     */
    async findByChurchId(churchId: string, options: UserQueryOptions = {}): Promise<PaginatedUsers> {
        const client = await pool.connect();
        ...
        LIMIT $${paramCount} OFFSET $${paramCount + 1}
            ...
            logger.error('Error in UserRepository.findByChurchId:', error);
     ...
     */
    async findAdminsByChurchId(churchId: string): Promise<UserWithoutPassword[]> {
        const client = await pool.connect();
        ...
        try {
            ...
            logger.error('Error in UserRepository.findAdminsByChurchId:', error);
     ...
     * Find users by role
     */
    async findByRole(churchId: string, role: UserRole): Promise<UserWithoutPassword[]> {
        const client = await pool.connect();
        ...
        try {
            ...
            logger.error('Error in UserRepository.findByRole:', error);
    ...
    async emailExists(email: string, excludeUserId?: string): Promise<boolean> {
        ...
        try {
            ...
            logger.error('Error in UserRepository.emailExists:', error);
     ...
     */
    async countByChurchId(churchId: string, options?: {
        role?: UserRole;
        status?: UserStatus
    }): Promise<number> {
        const client = await pool.connect();
        ...
        try {
            ...
            logger.error('Error in UserRepository.countByChurchId:', error);
    ...
    async verifyEmail(id: string): Promise<boolean> {
        ...
        try {
            ...
            logger.error('Error in UserRepository.verifyEmail:', error);
    ...
    async updateStatus(id: string, status: UserStatus): Promise<User | null> {
        ...
        try {
            ...
            if (result.rows[0]) {
                logger.info(`Status updated to '${status}' for user: ${id}`);
            }

            return result.rows[0] || null;
        } catch (error) {
            logger.error('Error in UserRepository.updateStatus:', error);
    ...
    async updateRole(id: string, role: UserRole): Promise<User | null> {
        ...
        try {
            ...
            if (result.rows[0]) {
                logger.info(`Role updated to '${role}' for user: ${id}`);
            }

            return result.rows[0] || null;
        } catch (error) {
            logger.error('Error in UserRepository.updateRole:', error);
    ...
    async hardDelete(id: string): Promise<boolean> {
        ...
        try {
            ...
            logger.error('Error in UserRepository.hardDelete:', error);
    ...
    async restore(id: string): Promise<User | null> {
        ...
        try {
            ...
            logger.error('Error in UserRepository.restore:', error);
     ...
     */
    async search(churchId: string, searchTerm: string, limit: number = 10): Promise<UserWithoutPassword[]> {
        const client = await pool.connect();
        ...
        try {
            ...
            logger.error('Error in UserRepository.search:', error);
     ...
     */
    async belongsToChurch(userId: string, churchId: string): Promise<boolean> {
        const client = await pool.connect();
        ...
        try {
            ...
            logger.error('Error in UserRepository.belongsToChurch:', error);
            throw new AppError('Failed to verify user church membership', 500);
        } finally {
            client.release();
        }
    }
    ...
    async hasRole(userId: string, roles: UserRole | UserRole[]): Promise<boolean> {
        ...
        try {
            ...
            logger.error('Error in UserRepository.hasRole:', error);
